...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(301, "{ SEMANTIC } Имеется более одной точки входа в primary"),
		ERROR_ENTRY(302, "{ SEMANTIC } Не имеется точки входа в primary"),
		...
		ERROR_ENTRY(309, "{ SEMANTIC } Несовпадение фактических и формальных параметров функции(превышение 10 параметров)"),
		ERROR_ENTRY(310, "{ SEMANTIC } Непдопустимый оператор в условии"),
		ERROR_ENTRY(311, "{ SEMANTIC } Ошибка при делении на ноль"),
		...
		ERROR_ENTRY(318, "{ SEMANTIC } Значение переменной типа char выходит за пределы допустимых значений"),
